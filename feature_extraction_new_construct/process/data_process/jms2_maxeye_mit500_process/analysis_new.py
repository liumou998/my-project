...
logfile = '/home/linux/ShenGang/feature_extraction_new_construct/process/data_process/data_jms2_process/combined_sys.log'  # 更新为合并后的日志路径

# 输出文件路径
output_dir = '/home/linux/ShenGang/feature_extraction_new_construct/process/data_process/data_jms2_process'
...
def retain_lines_by_port_type(input_file, output_file_1, output_file_2, output_file_3):
    ...
    Args:
        ...
        output_file_3 (str): prot_type 2 的输出文件路径
    """
    # 统计计数器
    counters = {'3': 0, '5': 0, '2': 0, 'other': 0, 'total': 0}
    ...
    try:
        ...
        print(f"prot_type 5 (ADAS2): {counters['5']} 条记录，保存到 {output_file_2}")
        print(f"prot_type 2 (ADAS3): {counters['2']} 条记录，保存到 {output_file_3}")
...
if __name__ == "__main__":
    ...
    print(f"  - ADAS2 (prot_type 5): {output_file_2}")
