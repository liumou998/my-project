...
if __name__ == "__main__":
    log_file_path = '/home/linux/ShenGang/feature_extraction_new_construct/process/data_process/jms2_maxeye_mit500_process/ADAS2.txt'  # 输入日志文件路径
    output_file_path = '/home/linux/ShenGang/feature_extraction_new_construct/process/data_process/jms2_maxeye_mit500_process/jms2_adas2_process.txt'  # 输出日志文件路径
