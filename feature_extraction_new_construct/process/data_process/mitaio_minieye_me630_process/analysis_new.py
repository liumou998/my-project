...
logfile = '/home/linux/ShenGang/feature_extraction_new_construct/process/data_process/mitaio_minieye_me630_process/MITAIO_conbine_sys.log'  # 更新为合并后的日志路径

# 输出文件路径
output_dir = '/home/linux/ShenGang/feature_extraction_new_construct/process/data_process/mitaio_minieye_me630_process'
...
def retain_lines_by_port_type(input_file, output_file_1, output_file_2, output_file_3):
    ...
    Args:
        ...
        output_file_1 (str): prot_type 9 的输出文件路径
        output_file_2 (str): prot_type 4 的输出文件路径
        output_file_3 (str): prot_type 8 的输出文件路径
    """
    # 统计计数器
    counters = {'9': 0, '4': 0, '8': 0, 'other': 0, 'total': 0}
    ...
    try:
        ...
        print(f"prot_type 9 (ADAS1): {counters['9']} 条记录，保存到 {output_file_1}")
        print(f"prot_type 4 (ADAS2): {counters['4']} 条记录，保存到 {output_file_2}")
        print(f"prot_type 8 (ADAS3): {counters['8']} 条记录，保存到 {output_file_3}")
...
if __name__ == "__main__":
    ...
    print(f"输出文件:")
    print(f"  - ADAS1 (prot_type 9): {output_file_1}")
    print(f"  - ADAS2 (prot_type 4): {output_file_2}")
    print(f"  - ADAS3 (prot_type 8): {output_file_3}")
